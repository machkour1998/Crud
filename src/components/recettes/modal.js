        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>
                <span className="modal-lable">
                  <label className="labTitre">Title:</label>
                </span>
                <input
              ...
              <p>
                <span className="modal-lable">
                  <label className="labIngrédients">Ingrédients:</label>
                </span>
                <input
                  className="form-control"
                  value={this.state.ingrédients}
                  onChange={(e) => this.msgHandler(e)}
                />
              </p>
              <p>
                <span className="modal-lable">
                  <label className="labImage">Image:</label>
                </span>
                <input
                  type="file"
                  className="form-control"
            ...
            <div className="modal-footer">
              <button
                style={{ backgroundColor: "#DCDDDD", color: "black" }}
                type="button"
              ...
              <button
                ...
                data-dismiss="modal"
                onClick={this.props.enregistrerModal.bind(
                  this,
                  this.props.index,
                  this.state
                )}
