...
class App extends Component {
    ...
    recettes: [
      {
        ...
        ingrédients:
          "2 tomates,250 g de boeuf haché,1 petite boîte de haricots rouges",
        image: "../images/chawarma.jpg",
      },
      {
        id: 2,
        titre: "Enchilladas au boeuf gratinés",
        ingrédients: "8 tortillas,450 gruyère râpé,20 cl de crème fraîche",
        image: "../images/gratin.jpg",
      },
      {
        id: 3,
        titre: "Gaspacho au Thermomix",
        ingrédients: "1 tranche de pain de mie,1 oignon,1/2 concombre",
  ...
  componentWillUpdate = (nextProps, nextState) => {
    if (this.storageAvailable("localStorage")) {
      const ref = localStorage.setItem(
        "recettes",
  ...
  componentWillMount = () => {
    if (this.storageAvailable("localStorage")) {
      const localRef = localStorage.getItem(
        "recettes",
        JSON.stringify(this.state.recettes)
      );
      if (localRef) {
  ...
  enregistrerModal = (id, item) => {
    ...
    localStorage.setItem("recettes", JSON.stringify(temprecipes));
  };
  ...
  deleteRecette = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire("Supprimer!", "la recette bien supprimer", "success");
        let resteRecettes = this.state.recettes.filter((x) => x.id !== id);
          ...
          <div className="row">
            <div className="col-md-12" style={{ marginBottom: "10px" }}>
              ...
              <div className="tab-content" id="pills-tabContent">
                ...
                >
                  <EditRecette
                    addNewRecette={this.addNewRecette.bind(this)}
